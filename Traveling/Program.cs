namespace Traveling
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Δώστε κατανάλωση καυσίμου (λίτρα/100km):");
            ...
            Console.WriteLine("Δώστε απόσταση σε km:");
            ...
            litersNeeded = Math.Round(distance * consumption / 100, 2); // Calculate total liters needed
